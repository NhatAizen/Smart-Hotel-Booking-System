...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DuplicateTransactionCodeException.class)
    public ResponseEntity<ApiErrorResponse> handleDuplicateTransactionCode(
            DuplicateTransactionCodeException exception,
            HttpServletRequest request
    ) {
        return build(
                HttpStatus.CONFLICT,
